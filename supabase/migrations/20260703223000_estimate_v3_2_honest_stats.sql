-- v3.2 do motor (revisão 2026-07-03), duas correções de honestidade estatística:
-- 1) Com n<3 comparáveis não há Chauvenet nem IC80; antes o código ainda persistia
--    grau_precisao='i', n_sanitized e a banda heurística 0.88/1.13 em ic80_low/high,
--    e o laudo declarava saneamento/IC falsamente. Agora essas colunas ficam NULL
--    quando o tratamento estatístico não roda (o laudo omite as frases).
-- 2) Grau de Precisão ganha o corte de 50% da NBR 14.653-2: amplitude do IC80 acima
--    de 50% da estimativa central não recebe grau nenhum (antes caía em Grau I).
