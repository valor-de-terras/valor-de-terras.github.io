...
const PLANS: Plan[] = [
  {
    ...
    name: "Freemium",
    price: "Grátis",
    priceNote: "1 laudo simplificado por mês",
    blurb:
      "Conheça a plataforma sem custo. Ideal para um primeiro teste antes de contratar um laudo formal.",
    features: [
      "1 laudo simplificado por mês",
  ...
  {
    id: "por-laudo",
    eyebrow: "Sob medida por imóvel",
    name: "Por laudo",
    price: "R$ 300–1.500",
    unit: "por laudo completo",
    blurb:
      "Laudo de avaliação fundamentado na NBR 14.653. O valor varia conforme a complexidade e a área do imóvel.",
    features: [
      "Laudo completo com homogeneização",
      "Método comparativo de mercado",
      "Fontes abertas referenciadas",
      "Pronto para uso técnico e formal",
    ],
    cta: { label: "Solicitar um laudo", href: "#demo", variant: "vt-btn-primary" },
    featured: true,
  },
  {
    id: "assinatura",
